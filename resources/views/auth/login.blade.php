            ...
            <main class="form-signin">
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="form-floating">
                        <input type="text" name="email" class="form-control" id="floatingInput" placeholder="you@example.com">
                    ...
                    <button class="w-100 btn btn-lg text-white" style="background: #07C53C" type="submit">Sign in</button>
                    <p class="mt-2 mb-3 text-muted">Don't have account ? <a href="{{ route("register") }}" style="color: #07C53C;text-decoration:none" >Register</a></p>
